...
import { FallingItemConfig, PlayerProfile, PowerUpType } from './types';
...
export const GAME_URL = 'https://leadarcade.com/koerner-chaos'; // Fallback/Canonical URL

// Asset Prompts (Stored for reference/future implementation as requested)
...
export const FALLING_ITEMS: FallingItemConfig[] = [
...
export const POWER_UPS: FallingItemConfig[] = [
